...
class IndiviualNotePage extends StatefulWidget {
  ...
  @override
  State<IndiviualNotePage> createState() => _IndiviualNotePageState();
}

class _IndiviualNotePageState extends State<IndiviualNotePage> {
  ...
  void openIndiviualNoteByTitle(String title) {}
